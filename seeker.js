...
var $prefs = {
  removeValueForKey: key => {
    ...
    console.log(err)
    $notification.post('Script Hub: 脚本转换', '❌ zeekr.js', err)
    return result
  },
  valueForKey: key => {
